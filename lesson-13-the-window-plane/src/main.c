...
int main( bool hard ) {
    ...
    PAL_setPalette(PAL3, horizontal_hud.palette->data, CPU); //misma paleta para el vertical hud / same palette for vertical hud

    //inicializa motor de sprites / Start sprite engine
    SPR_init();

    //El tile 0 est� reservado para uso del SGDK / Tile 0 is reserved by SGDK
    ind = 1;
    ...
    while(TRUE)
    {
        ...
        //Adem�s cierra el cerrojo del bucle secundario / Close secondary loop lock
        cargaESTADO();
