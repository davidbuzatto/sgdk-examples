...
//La funci�n as�ncrona detecta cuando hay un cambio en el estado de alg�n bot�n
...
int main( bool hard ) {
    ...
    while ( TRUE ) {
        //NO HACE FALTA PONER NADA EN EL MAIN (al contrario que en la forma s�ncrona)
