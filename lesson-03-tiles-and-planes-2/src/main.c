...
//estas constantes representar�n dos tiles, en posiciones de memoria VRAM 1 y 2
#define MI_TILE1 1
#define MI_TILE2 2
...
//en cada posici�n del vector guardamos 8 valores de 8 posiciones
//8x8=64=1 Tile
const u32 tile1[8]=
{
0x00000001,
...
/*  Pasos para dibujar un tile:
    ...
    - dibujar el tile (elegimos plano, posici�n).
...
//ojo, hemos cargado la tiles en VRAM pero NO hemos indicado a�n que se pinten
...
while(1)
{
    ...
    // as� que el SGDK los pinta con la paleta 0.
    ...
    //Ejemplo 2
    //Vamos a dibujar por �reas, rellenando cada �rea con tiles
